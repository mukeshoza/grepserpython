...
filename = 'C:\myfiles\QA\grepserpython\generalscripts_python\\testfile.json'
...
remp = ''',
            backgroundColor: [
                ...
                'rgba(257, 206, 86, 0.8)',
                'rgba(89, 192, 192, 0.8)',
                'rgba(157, 102, 255, 0.8)',
                'rgba(288, 130, 114, 0.8)',
                'rgba(286, 108, 24, 0.8)',
                'rgba(59, 162, 235, 0.8)',
                'rgba(237, 206, 86, 0.8)',
                'rgba(819, 192, 192, 0.8)',
                'rgba(167, 102, 255, 0.8)',
                'rgba(222, 130, 114, 0.8)',
                'rgba(233, 108, 24, 0.8)',
                'rgba(89, 192, 192, 0.8)',
                'rgba(157, 102, 255, 0.8)',
                'rgba(208, 140, 115, 0.8)',
                'rgba(233, 18, 288, 0.8)',
                'rgba(544, 162, 235, 0.8)',
                'rgba(247, 276, 86, 0.8)',
                'rgba(81, 190, 12, 0.8)',
                'rgba(17, 102, 255, 0.8)',
                'rgba(222, 10, 114, 0.8)',
...
statechart = '''<div style="float:right; width:45%; margin-top:-4%; margin-right:5%;">
