...
filename = 'C:\myfiles\QA\grepserpython\generalscripts_python\\testjson1.json'
...
grpnet = df.groupby(netgrp).size().reset_index(name='count')
for values in grpnet['index']:
    netgrpby.append(values)
for values1 in grpnet['count']:
    countnet.append(values1)

df1 = pd.DataFrame(statappend, columns=['state'])
statcount = df1.groupby(statappend).size().reset_index(name='count')
for valuestate in statcount['index']:
    stategrby.append(valuestate)
for valuesstate1 in statcount['count']:
...
if per > 8:
    result = '<b><font color = "red">address_string needs to be fixed!!!</b></font>'
else:
    result = '<b><font color = "green">address_string looks okay!!!</b></font>'

if percity > 8:
    resultcity = '<b><font color = "red">city needs to be fixed!!!</b></font>'
else:
    resultcity = '<b><font color = "green">city looks okay!!!</b></font>'

if perlang > 15:
    resutllang = '<b><font color = "red">language needs to be fixed!!!</b></font>'
else:
    resutllang = '<b><font color = "green">language looks okay!!!</b></font>'

if peroffice > 15:
    resultofc = '<b><font color = "red">office_name needs to be fixed!!!</b></font>'
else:
    resultofc = '<b><font color = "green">office_name looks okay!!!</b></font>'

if perphone > 15:
    resultphone = '<b><font color = "red">phone needs to be fixed!!!</b></font>'
else:
    resultphone = '<b><font color = "green">phone looks okay!!!</b></font>'

if perstate > 8:
    resultstate = '<b><font color = "red">state needs to be fixed!!!</b></font>'
else:
    resultstate = '<b><font color = "green">state looks okay!!!</b></font>'

if perzip > 8:
    resultzip = '<b><font color = "red">zip needs to be fixed!!!</b></font>'
else:
    resultzip = '<b><font color = "green">zip looks okay!!!</b></font>'

if peranp > 18:
    resultanp = '<b><font color = "red">accepting_new_patient needs to be fixed!!!</b></font>'
else:
    resultanp = '<b><font color = "green">accepting_new_patient looks okay!!!</b></font>'

if pernpi > 18:
    resultnpi = '<b><font color = "red">npi needs to be fixed!!!</b></font>'
else:
    resultnpi = '<b><font color = "green">npi looks okay!!!</b></font>'

if perpcp > 18:
    resultpcp = '<b><font color = "red">pcp needs to be fixed!!!</b></font>'
else:
    resultpcp = '<b><font color = "green">pcp looks okay!!!</b></font>'

if persuid > 8:
    resultsuid = '<b><font color = "red">site_uid needs to be fixed!!!</b></font>'
else:
    resultsuid = '<b><font color = "green">site_uid looks okay!!!</b></font>'

if peruname > 5:
    resultuname = '<b><font color = "red">Unparsed Name needs to be fixed!!!</b></font>'
else:
    resultuname = '<b><font color = "green">Unparsed Name looks okay!!!</b></font>'
if pfaci > 1:
    if perfacname > 8:
        resultfacname = '<b><font color = "red">Facility Name needs to be fixed!!!</b></font>'
    else:
        resultfacname = '<b><font color = "green">Facility Name looks okay!!!</b></font>'

    if perftype > 8:
        resultftype = '<b><font color = "red">Facility Type needs to be fixed!!!</b></font>'
    else:
        resultftype = '<b><font color = "green">Facility Type looks okay!!!</b></font>'
else:
    pass
if perfname > 5:
    resultfname = '<b><font color = "red">First Name needs to be fixed!!!</b></font>'
else:
    resultfname = '<b><font color = "green">First Name looks okay!!!</b></font>'

if perlname > 5:
    resultlname = '<b><font color = "red">Last Name needs to be fixed!!!</b></font>'
else:
    resultlname = '<b><font color = "green">Last Name looks okay!!!</b></font>'

if permname > 5:
    resultmname = '<b><font color = "red">Middle Name needs to be fixed!!!</b></font>'
else:
    resultmname = '<b><font color = "green">Middle Name looks okay!!!</b></font>'

if pergender > 5:
    resultgender = '<b><font color = "red">Gender needs to be fixed!!!</b></font>'
else:
    resultgender = '<b><font color = "green">Gender looks okay!!!</b></font>'

if pernet > 5:
    resultnet = '<b><font color = "red">Network needs to be fixed!!!</b></font>'
else:
    resultnet = '<b><font color = "green">Network looks okay!!!</b></font>'

if pertier > 8:
    resulttier = '<b><font color = "red">Network Tier needs to be fixed!!!</b></font>'
else:
    resulttier = '<b><font color = "green">Network Tier looks okay!!!</b></font>'

if pergrp > 12:
    resultgrp = '<b><font color = "red">Group Affiliations need to be fixed!!!</b></font>'
else:
    resultgrp = '<b><font color = "green">Group Affiliations look okay!!!</b></font>'

if perhosp > 12:
    resulthosp = '<b><font color = "red">Hospital Affiliations need to be fixed!!!</b></font>'
else:
    resulthosp = '<b><font color = "green">Hospital Affiliations look okay!!!</b></font>'

if perspec > 8:
    resultspec = '<b><font color = "red">Specialties need to be fixed!!!</b></font>'
else:
    resultspec = '<b><font color = "green">Specialties look okay!!!</b></font>'
...
<body>
<center><br><hr><h2>Vericred Project Summary Report</h2><hr></center>
...
table = '''</p></b><table class="table table-hover">
  <thead>
    <tr>'''
...
provchart = '''<div><div style="margin-left:3%; float: left; width:40%;">
...
remp = ''',
            backgroundColor: [
                ...
                'rgba(257, 206, 86, 0.5)',
                'rgba(89, 192, 192, 0.5)',
                'rgba(157, 102, 255, 0.5)',
                'rgba(288, 130, 114, 0.5)',
                'rgba(286, 108, 24, 0.5)',
                'rgba(59, 162, 235, 0.5)',
                'rgba(237, 206, 86, 0.5)',
                'rgba(819, 192, 192, 0.5)',
                'rgba(167, 102, 255, 0.5)',
                'rgba(222, 130, 114, 0.5)',
                'rgba(233, 108, 24, 0.5)',
                'rgba(89, 192, 192, 0.5)',
                'rgba(157, 102, 255, 0.5)',
                'rgba(208, 140, 115, 0.5)',
                'rgba(233, 18, 288, 0.5)',
                'rgba(544, 162, 235, 0.5)',
                'rgba(247, 276, 86, 0.5)',
                'rgba(81, 190, 12, 0.5)',
                'rgba(17, 102, 255, 0.5)',
                'rgba(222, 10, 114, 0.5)',
...
statechart = '''<div style="float:right; width:45%; margin-top:-5%;">
...
if pfaci > 1:
    alltable = table + table1 + tables + tables + table2 + table3 + table4 + table5 + table6 + table7 + table8 + table9 + \
           table10 + table11 + table12 + table13 + finalprov + table14 + table15 + table16 +\
           table17 + table18 + table19 + table20 + table21 + table22 + table23 + table24 + finalchartp + statefinalchart + tables2
else:
    alltable = table + table1 + tables + tables + table2 + table3 + table4 + table5 + table6 + table7 + table8 + table9 + \
...
with open(filename + '_vericred_summary_report.html', 'w', buffering=90000000) as html:
    html.write(htmlcollapse + totalpro + alltable + all)