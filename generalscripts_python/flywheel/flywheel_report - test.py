...
if filenameold == '' and filenamenew != '':
    ...
    tabkey1 = '<tr class = "table-light"><th scope="row">{}</th><th scope="col"></th><th scope="col"></th>'.format('Total Keywords')
    tabkey2 = '<td>{:,}</td></tr>'.format(lenkey)
...
if filenameold != '' and filenamenew != '':
    ...
    tab5 = '<tr class = "table-light" style="margin-bottom:5%;"><th scope="row">{}</th><th scope="col"></th><th scope="col"></th>'.format('Total Count')
